...
export default function Project({ title, description, tags, imageUrl, githubLink }: ProjectProps) {
  ...
  return (
    <motion.div
      ...
      <section className="group bg-gray-100 max-w-[42rem] borderBlack rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition group-even:pl-8">
