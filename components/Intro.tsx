  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <motion.h1 className="mb-10 mt-4 px-5 text-2xl font-medium !leading-[1.5] sm:text-[34px]" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }}>
        <span className="font-bold">Hi! I'm Daniel.</span> I'm a <span className="font-bold">full-stack developer</span> with <span className="font-bold"> 4 years</span> of
        experience. Recently, I have been focusing on <span className="underline">web app development</span>.
      </motion.h1>
